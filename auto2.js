    ...
    */
    ...
    class UIMenuStyles {
        addStyles() {
            ...
            style.innerHTML = `
            /* ========================================
               🎨 MODERN UI THEME - Enhanced Design
               ======================================== */
            ...
            .custom-script-menu-button::before,
            .custom-script-menu-link::before {
                content: '';
                position: absolute;
                top: 0;
                left: -100%;
            ...
            .custom-script-menu-button:hover::before,
            .custom-script-menu-link:hover::before {
                left: 100%;
            }
            ...
            .custom-script-dice-roll-select:hover {
                border-color: #667eea;
            ...
            /* ========================================
               🌄 NHÓM HOANG VỰC - Enhanced Design
               ======================================== */
            ...
            .custom-script-khoang-mach-config-group select:hover {
                border-color: #667eea;
                box-shadow: 0 4px 15px rgba(102, 126, 234, 0.3);
            }
            
            .custom-script-khoang-mach-config-group select:focus {
                outline: none;
                border-color: #764ba2;
                box-shadow: 0 0 0 3px rgba(102, 126, 234, 0.2);
            }
            ...
            .custom-script-hoang-vuc-settings-btn.searching {
                animation: searchIconToggle 1s infinite, rotateSearch 2s infinite linear;
            }
            ...
            /* ========================================
               📊 STATUS BAR - Enhanced Notifications
               ======================================== */
            ...
            .custom-script-message {
                ...
                box-shadow: 0 4px 15px rgba(0,0,0,0.3),
                            0 0 0 1px rgba(255,255,255,0.1);
                opacity: 0;
                animation: fadeInModern 0.4s cubic-bezier(0.4, 0, 0.2, 1) forwards;
                transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1);
